...
namespace RealEstates.Importer
{
    class Program
    {
        ...
        public static void ImportJsonFile(string fileName)
        {
            ...
            {
                propertiesService.Add(jsonProp.District, jsonProp.Price, jsonProp.Floor, jsonProp.TotalFloors, jsonProp.Size, jsonProp.YardSize, jsonProp.Year, jsonProp.Type, jsonProp.BuildingType);
                Console.Write(".");
            }
        }
    }
